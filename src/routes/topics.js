...
router.post("/topics/:topicId/topics/create", validation.validateTopics, topicController.create);
...
router.post("/topics/:topicId/topics/:id/update", validation.validateTopics, topicController.update);
