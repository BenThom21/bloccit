...
describe("routes : flairs", () => {
    ...
    beforeEach((done) => {
        ...
        sequelize.sync({force: true}).then((res) => {
            Topic.create({
                title: "Thanksgiving Sides",
                description: "Rank your top sides."
            })
            .then((topic) => {
                this.topic = topic;
    ...
    describe("POST /topics/:topicId/flairs/create", () => {
        ...
        it("should create a new flair and redirect", (done) => {
            ...
            // body the same as post pody or just response body? if not, this should then be 'color'
            request.post(options, (err, res, body) => {
        
                Flair.findOne({where: {name: "Winter"}})
                .then((flair) => {
    ...
    describe("POST /topics/:topicId/flairs/:id/update", () => {
        ...
        it("should update the flair with the given values", (done) => {
            ...
            request.post(options, (err, res, body) => {
                ...
                .then((flair) => {
                    expect(this.flair.name).toBe("Travel");
                    done();
                });
            });
        });
